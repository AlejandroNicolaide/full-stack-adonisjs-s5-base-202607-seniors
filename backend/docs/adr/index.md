...
# Architecture knowledge base — backend

Welcome 👋 to the architecture knowledge base of the **backend** package (AdonisJS API).
You will find here all the Architecture Decision Records (ADR) specific to this package.

For decisions that affect the whole monorepo, check the [global knowledge base](../../../docs/adr/index.md).
